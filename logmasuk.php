...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = $conn->prepare("SELECT id, username, peranan, emel, svm, semester FROM pengguna WHERE username = ? AND password = ?");
...
<div class="login-wrapper" data-aos="zoom-in">
    <div class="login-container">
        ...
        <p class="subtitle">Sila log masuk ke akaun E-pembelajaran Sains anda</p>
        ...
        <form action="" method="POST">
            ...
            <button type="submit" name="login" class="btn-login">Log Masuk Sekarang</button>
