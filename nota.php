...
<head>
  ...
  <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: "Plus Jakarta Sans", sans-serif; }
        ...
        .box h2 { font-size: 1.5rem; font-weight: 800; margin-bottom: 12px; color: var(--primary-soft); }
        .box p { font-size: 1rem; line-height: 1.5; color: #636e72; font-weight: 500; }
...
<main>
    ...
    <div class="container">
        <a href="Langkah Keselamatan Dalam Makmal.pdf#toolbar=0" target="_blank" class="box" data-aos="fade-up" data-aos-delay="100">
        ...
        <a href="Bantuan Kecemasan.pdf#toolbar=0" target="_blank" class="box" data-aos="fade-up" data-aos-delay="200">
            <div class="icon-circle">
        ...
        <a href="Teknik Mengukur Parameter Kesihatan Badan.pdf#toolbar=0" target="_blank" class="box" data-aos="fade-up" data-aos-delay="300">
            <div class="icon-circle">
