...
<div class="acc-wrapper">
    ...
    <div class="acc-menu" id="accMenu">
        ...
        <div class="acc-item" onclick="resetAcc()" style="color: #e74c3c; border-bottom: none; justify-content: center; font-weight: 800;">
            <img src="reset.png" alt="Reset"> Tetapan Asal
        </div>
    </div>
</div>
...
<section class="hero">
    ...
    <div class="hero-text">
        <h1>E-PEMBELAJARAN SAINS PENSYARAH</h1>
...
<div class="content-container">
    ...
    <div class="button-grid">
        <a href="p.nota.php" class="main-btn nota-card">
            <img src="nota.png" alt="Ikon Nota" class="btn-icon-img">
            <span>Nota</span>
        </a>

        <?php if(isset($_SESSION['id'])) { ?>
            <a href="r-pelajar.php" class="main-btn rekod-card">
                <img src="rekod.png" alt="Ikon Rekod" class="btn-icon-img">
                <span>Rekod Pelajar</span>
            </a>
        <?php } else { ?>
